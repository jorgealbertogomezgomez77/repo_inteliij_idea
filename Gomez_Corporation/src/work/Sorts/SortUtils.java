 ...
 *
 * @author Jorge Alberto Gomez Gomez (https://github.com/nikitap492)
...
final class SortUtils {
    ...
    /**
     * This method check if first element is less then the other element
     * @param v first element
     * @param w second element
     * @return true if the element is less then the second element
     */
