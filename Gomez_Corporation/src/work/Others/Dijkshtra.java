...
public class Dijkshtra {
    public static void main(String[] args) {
        ...
        /*From above, we have assumed that, initially path b/w any two Pair of vertices
        * is Infinite such that Infinite = 10000001. For simplicity, We can also take
        * path Value = Long.MAX_VALUE, but i have taken Max Value = 10000001
        */
        ...
        for (int i = 1; i <= n; i++) {
            if (i != src && w[src][i] != 10000001) {
                System.out.println(w[src][i] + " ");
            }

            // Printing -1 if there is no path b/w given pair of edge
            else if (i != src) {
                System.out.print("-1" + " ");
            }
        }
