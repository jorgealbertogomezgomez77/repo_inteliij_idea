...
public class AES {
    ...
    public static BigInteger scheduleCore(BigInteger t, int rconCounter) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            rBytes = rBytes.substring(0, i * 2) +
                    currentByteBits + rBytes.substring((i + 1) * 2);
        }
    ...
    public static BigInteger[] keyExpansion(BigInteger initialKey) {
        BigInteger[] roundKeys = {initialKey,
                new BigInteger("0"),
                new BigInteger("0"),
                new BigInteger("0"),
                new BigInteger("0"),
        ...
        for (int i = 1; i < 11; i++) {
            // Get the previous 32 bit the key
    ...
    public static BigInteger mergeCellsIntoBlock(int[] cells) {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            // Append leading 0 for full "8-bit" string
