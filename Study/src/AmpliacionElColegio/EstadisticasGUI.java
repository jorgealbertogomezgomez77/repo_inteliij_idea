...
public class EstadisticasGUI extends javax.swing.JFrame {
    Colegio colegio;
    ...
    public EstadisticasGUI(Colegio cole) {
        colegio = cole;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText("Histograma");
        ...
        jLabel1.setText("Estadisticas del colegio");

        jLabel2.setText("Introduce el Aula");

        jButton1.setText("Grafica de lineas");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jaula, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        int idaula = Integer.valueOf(this.jaula.getText());
        try {
            //Thread.sleep(100);
            Histograma h = new Histograma(colegio.getAulas()[idaula]);
        } 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            //Thread.sleep(100);
            GraficaLineas h = new GraficaLineas(colegio.getAulas()[idaula]);
        } 
        catch (InterruptedException ex) {
            Logger.getLogger(EstadisticasGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstadisticasGUI().setVisible(true);
            }
        });
    }
